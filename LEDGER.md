...
**3 entries** · 3 missed by the project's existing tooling
...
| DATA | HIGH | `none` | ✅ | [The checks that catch bad data are the ones that disappear when the data is bad](proof/0003-validator-skips-what-it-cannot-check.md) |
